...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-grow flex flex-col items-center justify-center p-4 md:p-8 relative overflow-hidden bg-slate-950">
        ...
        <div className="z-10 flex flex-col items-center text-center max-w-lg">
          <div className="mb-6 inline-flex p-4 shadow-xl">
            <Ghost className="w-12 h-12 text-blue-400 animate-spin" />
          </div>
          
          <h1 className="text-8xl font-black text-white/90 mb-2 select-none">404</h1>
          
          <h2 className="text-2xl md:text-3xl font-bold text-white/90 mb-4">You've hit a dead end!</h2>
          
          <div className="min-h-[3rem] mb-10 flex items-center justify-center">
